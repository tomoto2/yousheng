...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:16px; margin:0;padding:0px;border:1px solid black;border-radius: 10%/15%;}";
	...
	strStyle += ".calendar li a{ text-decoration:none; font-family:Tahoma; font-size:16px; color:#333}";
	...
	strStyle += ".lastMonthDate, .nextMonthDate {color:#bbb;font-size:16px}";
	...
	strStyle += ".calendarTitle{text-align:center;height:3rem;line-height:3rem;clear:both;width:100%;}";
	strStyle += ".calendarTitle .mark{text-decoration:none;color:#000;font-family:Tahoma;font-size:40px;font-weight:normal;}";
	strStyle += ".today{ background-color:#ffffaa;border:1px solid #f60;padding:0 1px;}";
	strStyle += ".today a { color:#f30; }";
	strStyle += ".calendarBottom {text-align:center;height:0px;line-height:0px;clear:both;width:100%;border-top:1px solid #ddd;}";
	strStyle += ".calendarBottom li{float:left;height:0px;line-height:0px;font-weight:bold;text-align:center;}";
	strStyle += "</style>";
	return strStyle;
}
...
Calendar.prototype.draw = function() {   
  ...
  if("d" == this.type){
    ...
    lis += "<li style='width:30%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + "</span>" + Calendar.language["title"][this.lang][0] + "</li>";
  	if(0 == this.lang){
  		lis += "<li stye='width:20%;'><span id='selectThisMonth' class='selectThisMonth'>" + Calendar.language["months"][this.lang][this.date.getMonth()] + "</span></li>";
  	}else{l
	...
	lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[this.lang][0] +"</li>";
  	...
  	for(var i=1; i<=12; i++){
  		...
  		lis += "<li style='height:3rem' class='thisMonth' title='" + this.year + "-" + (i>9?i:"0"+i) + "-01'><a href='javascript:void(0);'";
...
Calendar.prototype.selectThisYear = function(){
	...
	var selectStr = "<select style='font-size:16px;'>";
...
//	this.panel.style.height = height;calendar
...
function fun(s){
	document.write('<div id="calendarPanel" style="position:absolute;z-index:9;background-color:#FFFFFF;font-size:16px;width:300px;height:12rem">');
