...
public class IHttpClientUtil {
    ...
    public String executeGet(String url, String resultCharset, String contentType)
            throws IOException {
        IHttpGet get = new IHttpGet(url);
        get.setContentType(contentType == null ? IHttpRequestBase.CONTENT_TYPE : contentType);
    ...
    public String executePost(String url, String data, String resultCharset, String requestCharset, String contentType)
        ...
        post.setEntity(data);
        post.setCharset(requestCharset);
        post.setContentType(contentType == null ? IHttpRequestBase.CONTENT_TYPE : contentType);
     ...
     * @throws IOException IO异常
     */
    private String execute(IHttpRequestBase request, String resultCharset) throws IOException {
        IHttpConfig config = new IHttpConfig();
        request.setHttpConfig(config);
