...
public class LunarCalendar {
	 ...
	 * @return 指定年份对应的生肖
	 */
	final public static String animalsYear(int year) {
	 ...
	 */
	final public static int[] calElement(int year, int month, int day) {
	...
	public static int[] today() {
		...
		int[] l = calElement(year, month, date);
		return l;
	}
	 ...
	 * @return 指定年份的弄农历有多少天
	 */
	final private static int lYearDays(int year) {
		int i, sum = 348;
